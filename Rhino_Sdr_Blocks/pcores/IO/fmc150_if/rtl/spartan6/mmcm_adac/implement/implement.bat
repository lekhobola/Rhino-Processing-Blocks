...
xst -ifn xst.scr
move mmcm_adac_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\mmcm_adac_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc mmcm_adac_exdes.ucf mmcm_adac_exdes

echo 'Running map'
map -timing -pr b mmcm_adac_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm mmcm_adac_exdes -w routed.ncd routed.vhd
cd ..
